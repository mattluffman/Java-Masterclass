...
public class NumberOfDaysInMonth {
    ...
    public static boolean isLeapYear(int year) {
        ...
        try {
            if (year < 1 || year > 9999) {
                throw new IllegalArgumentException("Year is not in range of 1-9999 inclusive.");
        ...
        try {
            ...
            switch (month) {
                ...
                case 11:
                    ...
                    break;
                default:
                    throw new IllegalArgumentException("We should never get here, but the compiler must be appeased");
            }
        } catch (IllegalArgumentException e) {
            daysInMonth = -1;
        }
