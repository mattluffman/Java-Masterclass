...
/**
 * section 7, exercise 39 - polymorphism
 *
 * @author Matt Luffman
 * Date: 5/27/2022
 * Time: 5:24 PM
...
public class Main {
     ...
     *
     * The other three classes mentioned above are sub-classes of Car. These classes have no member variables and the constructor for each will call the parent constructor for object instantiation. Each of these classes will override the three parent methods startEngine, accelerate, and brake. The
     * return messages for these methods should somewhere contain the name of the class to which the methods belong.
     *
     * Example input:
     *
